...
function CariData() {
  ...
  //  var cell5 = row.insertCell(4);
    ...
    cell1.innerHTML = '<button class="btn btn-primary btn-sm" type="button" id="update_data" onclick="updateData_Tampil(' + childData.id + '),pauseAudio()" data-toggle="modal" data-target="#ModalUpdate" style="box-shadow: 0 0 8px black;">online</button>';
